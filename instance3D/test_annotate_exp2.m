...
%add bookshelf 1
Utmp = U(1:3,nbrpoints_sfm+[1:7]);
shelfindex = [1,2,23,24,26,25,27];
...
%add bookshelf 2
Utmp = U(1:3,nbrpoints_sfm+[8:19]);
shelfindex = [1,4,11,12,2,3,23,24,26,30,27,7];
[trishelf, Ushelf] = annotate_addshelf(Utmp, shelfindex);
...
%add bookshelf 3
Utmp = U(1:3,nbrpoints_sfm+[40:52]);
shelfindex = [1,11,12,2,23,24,6,7,25,29,26,30,28];
[trishelf, Ushelf] = annotate_addshelf(Utmp, shelfindex);
...
nbrpoints_anno = nbrpoints_sfm+52;
