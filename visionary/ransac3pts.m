function [P, inliers] = ransac3pts(u, U, tol, iters)
    % [P, inliers] = ransac3pts(u, U, tol, iters)
    %
    % Performs 3 point RANSAC for pose of calibrated camera. u should be a
    % 2xN matrix with normalized image coordinates, U should be a 3xN
    % matrix with corresponding 3D points. tol is the reprojection
